    ...
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div className="overflow-y-auto" style={{maxHeight: '24rem'}}>
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">DuaAayush</span>
                      <span className="ml-auto font-semibold">9.3</span>
                    </li>
                    <li className="flex items-center">
                    
                      <span className="text-gray-600">Aadil verma</span>
                      <span className="ml-auto font-semibold">8.9</span>
                    </li>
                    <li className="flex items-center">
                   
                      <span className="text-gray-600">Abhay sen</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Abhinav</span>
                      <span className="ml-auto font-semibold">8.2</span>
                    </li>
                    <li className="flex items-center">
                    
                      <span className="text-gray-600">Abhay</span>
                      <span className="ml-auto font-semibold">8.1</span>
                    </li>
                    <li className="flex items-center">
                     
                      <span className="text-gray-600">Aditya</span>
            ...
            <section className="text-right font-semibold text-gray-500">
              <a href="#" className="text-purple-600 hover:underline">BookSynergy by DuaAayush</a> 
            </section>
    </>
  )
}
